...
import dev.jfxde.fxmisc.richtext.AreaWrapper;
...
public class HighlightBlockDelimiterExtension<T extends StyleClassedTextArea> extends AreaWrapper<T>  {

    public HighlightBlockDelimiterExtension(T area) {
        super(area);
